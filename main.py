...
class DataBase:
    def __init__(self, host="localhost", database="school") -> None:
        self.host = host
...
class InsertDialog(QDialog):
    ...
    def add_student(self):
        ...
        conn = DataBase().connect()
        cur = conn.cursor()
        cur.execute("INSERT INTO students(name, course, phone) VALUES (%s,%s,%s)",
                    (name, course, phone))
        conn.commit()
...
class EditDialog(QDialog):
    ...
    def edit_student(self):
        ...
        conn = DataBase().connect()
        cur = conn.cursor()
        cur.execute("UPDATE students SET name = %s, course = %s, phone = %s "\
